...
public class DdcaTestContainer extends TestContainer {

    public DdcaTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "de/diedavids/cuba/attachable/app.properties",
    ...
    public static class Common extends DdcaTestContainer {

        public static final DdcaTestContainer.Common INSTANCE = new DdcaTestContainer.Common();
